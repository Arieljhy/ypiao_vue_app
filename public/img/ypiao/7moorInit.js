...
(function () {
    ...
    window.getChatConfig = function (c) {
        onlineData = c;
        if (c.ubaOnOff !== 'true') {
          qimo_config.ubaOnOff = 'false'
        } else {
          qimo_config.ubaOnOff = c.ubaOnOff
        }
        if (c.uvpvSwitch !== 'true') {
          qimo_config.uvpvSwitch = 'false'
        } else {
          qimo_config.uvpvSwitch = c.uvpvSwitch
        }
        if (c.sessionInvitation !== '1') {
          qimo_config.sessionInvitation = '0'
        } else {
          qimo_config.sessionInvitation = c.sessionInvitation
        }
